...
private fun MainScreen() {
    val basicTestViewModel = BasicTestViewModel()
    Surface(
        ...
        Surface(
            ...
            Column(
                ...
                Column(
                    ...
                    NameList(nameList = basicTestViewModel.nameList.observeAsState().value)
                }
                NameTextField(value = basicTestViewModel.nameText.observeAsState().value) { newText -> basicTestViewModel.onTextChanged(newText) }
                SubmitButton { basicTestViewModel.addNewName(basicTestViewModel.nameText.value) }
            }
        }
    }
}
